...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ErrorDTO> handleGeneral(Exception ex) {
		ErrorDTO error = errorDTO("SERVER_ERROR", "Error desconocido", ex);
	...
	public ResponseEntity<ErrorDTO> handleNoSuchElement(Exception ex) {
		ErrorDTO error = errorDTO("NOT_FOUND", "Elemento no encontrado", ex);
	...
	public ResponseEntity<ErrorDTO> handleIllegalArgument(Exception ex) {
		ErrorDTO error = errorDTO("INVALID_ARGUMENT", "Parámetro inválido: " + ex.getMessage(), ex);
		return new ResponseEntity<>(error, HttpStatus.BAD_REQUEST);
	}
	...
	public ResponseEntity<ErrorDTO> handleIllegalState(Exception ex) {
		ErrorDTO error = errorDTO("ILLEGAL_STATE", ex.getMessage(), ex);
		return new ResponseEntity<>(error, HttpStatus.BAD_REQUEST);
	}
	...
	public ResponseEntity<ErrorDTO> handleAuthentication(Exception ex) {
		ErrorDTO error = errorDTO("AUTH_ERROR", "Credenciales inválidas", ex);
		return new ResponseEntity<>(error, HttpStatus.BAD_REQUEST);
	}
	...
	public ResponseEntity<ErrorDTO> handleAccessDenied(Exception ex) {
		ErrorDTO error = errorDTO("FORBIDDEN", "Autenticación requerida", ex);
		return new ResponseEntity<>(error, HttpStatus.BAD_REQUEST);
	}
